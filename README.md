...
The project takes data all the way through from generation to serving (including a dashboard). Various data modelling techniques were used in order to answer the following business questions:
